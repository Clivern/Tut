...
title: Development
description: In this section you will learn how to change Tut codebase, run it locally and run test cases.
keywords: mcp-gateway, mcp, model-context-protocol, clivern, ai
comments: false
order: 5
hero:
    title: Development
    text: In this section you will learn how to change Tut codebase, run it locally and run test cases.
---

## Development

Tut is built with Go. To run it locally, you need:
